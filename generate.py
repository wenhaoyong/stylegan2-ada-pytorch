...
def create_image_grid(images, grid_size=None):
    ...
    num, img_h, img_w = images.shape

    # If user specifies the grid shape, use it
    if grid_size is not None:
        grid_w, grid_h = tuple(grid_size)
    # Otherwise, we can infer one by the number of images
    else:
...
@click.option('--save-grid', help='Use flag to save image grid', default=False, show_default=True)
...
def generate_images(
    ...
    noise_mode: str,
    save_grid: bool,  # TODO: create grid function (automatically arrange images) and save it
    outdir: str,
